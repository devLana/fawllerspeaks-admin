...
export const sunnyPalette: Palette = {
  mode: "light",
  primary: { light: "#a2def6", main: "#7dd1f3", dark: "#118bbb" },
  secondary: { light: "#b3b3b3", main: "#6a6a6a", dark: "#404040" },
  text: {
    primary: "#04232f",
...
export const sunsetPalette: Palette = {
  ...
  primary: { light: "#a2def6", main: "#7dd1f3", dark: "#118bbb" },
  secondary: { light: "#b3b3b3", main: "#6a6a6a", dark: "#404040" },
  error: { light: "#fcc", main: "#ff8080", dark: "#f33" },
  text: {
    primary: "#d9d9d9",
...
export const pitchBlackPalette: Palette = {
  ...
  primary: { light: "#a2def6", main: "#7dd1f3", dark: "#118bbb" },
  secondary: { light: "#b3b3b3", main: "#6a6a6a", dark: "#404040" },
  error: { light: "#f99", main: "#f00", dark: "#c00" },
